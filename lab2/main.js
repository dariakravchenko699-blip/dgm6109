...
/* variables for x and y positions, relatively we are going to manipulate all of the other values. */
let dx = 70 /// a random duck's x position (original = 100)
let dy = 30 /// a randowm duck's y position (original = 50)
